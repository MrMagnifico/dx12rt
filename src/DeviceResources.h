...
namespace DX
{
    ...
    public:
        ...
        D3D12MA::Allocator*         GetD3DMAllocator() const { return m_d3d12maAllocator.Get(); }
        ...
        ID3D12Resource*             GetDepthStencil() const { return m_depthStencil.resource.Get(); }
